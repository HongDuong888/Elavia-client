    ...
    <div className="py-6 px-4 font-bold border-[1px] border-gray-300 rounded-tl-[40px] rounded-br-[40px] sm:border-1">
      <nav>
        <div className="relative font-semibold text-gray-500 flex items-center gap-2 p-4 cursor-pointer group">
          ...
          <div className="absolute top-[100%] left-4 mt-2 hidden group-hover:flex flex-col items-start bg-white border border-gray-300 shadow-md rounded-lg px-4 py-2 z-50 w-[240px]">
        ...
        <ul>
          <li className="px-4 py-2">
            <div className="pb-6 pt-4 font-[550] text-gray-500 text-[14px] flex gap-1 items-center hover:text-black transition-colors duration-200">
              <svg
          ...
          <li className="px-4 py-2">
            <div className="pb-6 font-[550] text-gray-500 text-[14px] flex gap-1 items-center hover:text-black transition-colors duration-200">
              ...
              >
                <path
                  d="M48 256C48 141.1 141.1 48 256 48c63.1 0 119.6 28.1 157.8 72.5c8.6 10.1 23.8 11.2 33.8 2.6s11.2-23.8 2.6-33.8Cავ
...
C403.3 34.6 333.7 0 256 0C114.6 0 0 114.6 0 256c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"
          ...
          <li className="px-4 py-2">
            <div className="pb-6 font-[550] text-gray-500 text-[14px] flex gap-1 items-center hover:text-black transition-colors duration-200">
              ...
              <Link to="/wish-products">Sản phẩm yêu thích</Link>
            </div>
          </li>
          <li className="px-4 py-2">
            <div className="font-[550] text-gray-500 text-[14px] flex gap-1 items-center hover:text-black transition-colors duration-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                className="w-3 h-3 text-gray-500"
