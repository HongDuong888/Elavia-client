...
const MenuInfo = () => {
  ...
  return (
    <div className="p-8 w-[300px] font-bold border rounded-tl-[40px] rounded-br-[40px] border-gray-700 h-[420px]">
      <nav>
       <div className="relative group font-semibold text-gray-500 flex items-center gap-2 p-4 cursor-pointer">
        <img src="/images/useravt.png" className="w-8 h-8 rounded-full" alt="Avatar" />
        <span className="truncate max-w-[140px]">{auth.user.email}</span>

        {/* Tooltip hiển thị khi hover */}
        <div className="absolute top-[100%] left-4 mt-2 hidden group-hover:flex flex-col items-start bg-white border shadow-md rounded-lg px-4 py-2 z-50 w-[240px]">
        ...
        <ul>
          ...
          <li className="px-4 py-2">
            <div className="pb-6 font-[550] text-gray-500 text-[14px] flex gap-1 items-center hover:text-black transition-colors duration-200">
              ...
              <Link to="/favorite_products">Sản phẩm yêu thích</Link>
            </div>
          </li>
        </ul>
      </nav>
