      ...
      <ClientLayout>
        <article className="mt-[82px]">
          ...
          <div className="flex justify-center pb-6 md:pb-8 pt-2 md:pt-4">
            <button
              className={`pr-3 md:pr-6 text-lg md:text-xl ${
                activeTab === "women" ? "font-bold text-black underline" : "text-gray-500"
              }`}
            ...
            <button
              className={`pl-3 md:pl-6 text-lg md:text-xl ${
                activeTab === "men" ? "font-bold text-black underline" : "text-gray-500"
              }`}
          ...
          <div className="flex justify-center pb-6 md:pb-8">
            <button
              className={`pr-3 md:pr-6 text-lg md:text-xl ${
                activeCollectionTab === "women" ? "font-bold text-black underline" : "text-gray-500"
              }`}
            ...
            <button
              className={`pl-3 md:pl-6 text-lg md:text-xl ${
                activeCollectionTab === "men" ? "font-bold text-black underline" : "text-gray-500"
              }`}
